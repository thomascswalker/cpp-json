...
namespace JSON
{
    ...
    /// <summary>
    /// StringType JSON value. Does not contain wrapped quotes, they are not necessary because
    /// of the defined type.
    /// </summary>
    class StringValue
        : public value_t
    ...
    public:
        explicit StringValue(std::string& value)
            : m_value(value) { };
        explicit StringValue(const std::basic_string<char>& value)
            : m_value(value) { };
